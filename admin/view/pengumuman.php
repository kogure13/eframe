      ...
      <table id="lookup"
        ...
        <thead>
          <tr>
            ...
            <th>Tanggal Pengumuman</th><th>Update Terakhir</th>
          </tr>
        </thead>
        <tbody></tbody>
      </table>
      ...
      <form id="form_model" name="form_model" novalidate="novalidate">
        <div class="modal-body">
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-sm-4">
                ...
                <?= $userUI->inputText("input", "input-sm form-control", "judul", "judul", "Judul Pengumuman")
                ?>
              </div>              
            </div>                            
          </div>
          <div class="form-group">
            <div class="row">
              <div class="col-sm-12">
                <?= $userUI->closeTags("textarea", "", "textPengumuman", "textPengumuman") ?>
              </div>
            </div>              
          </div>
        </div>
