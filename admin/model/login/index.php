      ...
      <div class=" card-box">
        <div class="row">
          ...
          <div class="col-sm-9 col-xs-9">
            ...
            <h4 class="hidden-xs" style="margin-bottom: 2px;"><?= apps_name ?></h4>
            <h5 class="hidden-xs" style="margin-top: 2px;"><?= company_name ?></h5>
          </div>
        </div>
        ...
        <div class="panel-body">
          <form class="form-horizontal m-t-20" id="login" name="login">
            ...
            <div class="form-group text-center m-t-40">
              <div class="col-xs-12">
                <button class="btn btn-primary btn-block text-uppercase m-b-10" type="submit">Log In</button>
